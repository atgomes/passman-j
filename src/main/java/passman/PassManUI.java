...
public class PassManUI extends javax.swing.JFrame {
        ...
        if(Arrays.equals(newUserPasswordField.getPassword(),newUserPasswordField2.getPassword())){
            ...
            if(!newUserField.getText().isEmpty()){
                if(Utils.createNewUser(newUserField.getText(), new String(newUserPasswordField.getPassword())) == 0){
                    ...
                    ErrorDialog errDlg = new ErrorDialog(new JFrame(), java.util.ResourceBundle.getBundle("Bundle").getString("INVALIDUSERNAME"), java.util.ResourceBundle.getBundle("Bundle", Locale.getDefault()).getString("USERNAMEEXISTS"));
                }
            } else{ // Username is empty
                ErrorDialog errDlg = new ErrorDialog(new JFrame(), java.util.ResourceBundle.getBundle("Bundle", Locale.getDefault()).getString("INVALIDUSERNAME"), java.util.ResourceBundle.getBundle("Bundle", Locale.getDefault()).getString("USERNAMEEMPTY"));
            }
        } else{ // Passwords are not the same
            ErrorDialog errDlg = new ErrorDialog(new JFrame(), java.util.ResourceBundle.getBundle("Bundle", Locale.getDefault()).getString("PASSWORDSDIFFER"), java.util.ResourceBundle.getBundle("Bundle", Locale.getDefault()).getString("PASSWORDSDIFFERMSG"));
        }
    ...
    private void attemptLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_attemptLoginActionPerformed
        if(Utils.tryLogin(loginUsername.getText(), new String(loginPassword.getPassword()))){
            ...
            ErrorDialog errDlg = new ErrorDialog(new JFrame(), java.util.ResourceBundle.getBundle("Bundle", Locale.getDefault()).getString("LOGINFAILED"), java.util.ResourceBundle.getBundle("Bundle", Locale.getDefault()).getString("LOGINFAILEDMSG"));
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            for (javax.swing.UIManager.LookAndFeelInfo info : javax.swing.UIManager.getInstalledLookAndFeels()) {
                if (java.util.ResourceBundle.getBundle("Bundle", Locale.getDefault()).getString("NIMBUS").equals(info.getName())) {
